...
var potentialSecondLevelFriends = secondLevelFriends.filter(function(friend, index, array) {
  return isNotAFriend(friend);
});
var allPotentialFriends = allUsers.filter(function(friend, index, array) {
  return isNotAFriend(friend);
});
